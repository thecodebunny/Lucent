...
(function(factory) {
    ...
    iziModal.prototype = {
        ...
        init: function(element, options) {
            ...
            this.$navigate = $('<div class="' + PLUGIN_NAME + '-navigate"><div class="' + PLUGIN_NAME + '-navigate-caption"></div><div class="' + PLUGIN_NAME + '-navigate-prev"></div><div class="' + PLUGIN_NAME + '-navigate-next fa fa-hand-o-right"></div></div>');
            this.group = {
            ...
            if (options.zindex !== null && !isNaN(parseInt(options.zindex))) {
                ...
                this.$navigate.css('z-index', options.zindex + 2);
                    ...
                    if (that.group.ids.length > 1) {
                        ...
                        if (that.options.navigateArrows !== false) {
                            if (that.options.navigateArrows === 'closeScreenEdge') {
                                ...
                                that.$navigate.find('.' + PLUGIN_NAME + '-navigate-next').css('margin-right', -((modalWidth / 2))).show();
                            }
                        } else {
        ...
        setZindex: function(zIndex) {
            ...
            if (!isNaN(parseInt(this.options.zindex))) {
                ...
                this.$navigate.css('z-index', zIndex - 2);
        ...
        recalcLayout: function() {
            ...
            if (this.state == STATES.OPENED || this.state == STATES.OPENING) {
                ...
                if (outerHeight > windowHeight) {
                    ...
                    this.$element.css('height', contentHeight + (this.headerHeight));
